...
person_tuple_list_test_() ->
	People = [{'name1', 'male', 4.3},{'name2', 'female', 5.5},{'name3', 'male', 6.6},{'name4', 'female', 7.7},{'name5', 'male', 8.8},{'name6', 'female',2.2},{'name7', 'male',1.1},{'name8', 'female', 1.3}], % TODO: Replace this with the list of tuples described in the previous comment
